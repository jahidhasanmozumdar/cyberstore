    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
      <div className="min-h-[417px] max-h-[417px] min-w-[310px] max-w-[310px] border border-sky-500 px-[5px]">
        ...
        <div className="min-h-[250px] max-h-[250px] min-w-[287px] max-w-[287px] flex justify-center">
          <img
            src="https://cyberstore.qodeinteractive.com/wp-content/uploads/2017/08/h1-product-1-768x768.jpg"
            alt=""
          />
        </div>
        <div className="flex flex-col gap-[10px]">
          ...
          <div>
            <h3 className="text-[14px]">
              Apple MacBook Pro With Touch Bar MF841DSN/A 13″
            </h3>
          </div>
          <div className="flex justify-between items-center">
            <h5 className="text-[18px]">$1,259</h5>
